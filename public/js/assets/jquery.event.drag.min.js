...
;(function (e) {
  ...
  var b = e.event,
    ...
    d = (a.drag = {
      ...
      init: function (i) {
        ...
        if (
          g.handle &&
          !e(i.target).closest(g.handle, i.currentTarget).length
        ) {
          return
        }
      ...
      handler: function (h) {
        ...
        switch (h.type) {
          ...
          case !g.dragging && "mousemove":
            if (
              Math.pow(h.pageX - g.pageX, 2) + Math.pow(h.pageY - g.pageY, 2) <
              Math.pow(g.distance, 2)
            ) {
              break
            }
            h.target = g.target
      ...
      hijack: function (h, o, r, p, k) {
        ...
        var q = { event: h.originalEvent, type: h.type },
      ...
      textselect: function (g) {
        e(document)
          [g ? "unbind" : "bind"]("selectstart", d.dontstart)
          .css("MozUserSelect", g ? "" : "none")
  ...
  var c =
    (b.fixHooks.touchstart =
    b.fixHooks.touchmove =
    b.fixHooks.touchend =
    b.fixHooks.touchcancel =
      {
